...
public class Godcard extends AbstractDynamicCard {
    ...
    public static final String ID = QueenMod.makeID(Godcard.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    ...
    public Godcard() { // public ${NAME}() - This one and the one right under the imports are the most important ones, don't forget them
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p,p,new SwarmPower(p,p,10),10));
    }
