...
public class GatherOrder extends AbstractDynamicCard {

    // TEXT DECLARATION

    public static final String ID = QueenMod.makeID(GatherOrder.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    ...
    public GatherOrder() { // public ${NAME}() - This one and the one right under the imports are the most important ones, don't forget them
