...
public class HoneyBeeCommander extends AbstractDynamicCard {

    // TEXT DECLARATION

    public static final String ID = QueenMod.makeID(HoneyBeeCommander.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    ...
    public HoneyBeeCommander() { // public ${NAME}() - This one and the one right under the imports are the most important ones, don't forget them
