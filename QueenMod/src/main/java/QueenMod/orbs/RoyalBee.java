...
import static QueenMod.QueenMod.makeOrbPath;

public class RoyalBee extends AbstractOrb {

    // Standard ID/Description
    public static final String ORB_ID = QueenMod.makeID("RoyalBee");
