...
public class AeroPower extends AbstractPower implements CloneablePowerInterface {
    public AbstractCreature source;
    public boolean used;

    public static final String POWER_ID = DrifterMod.makeID("AeroPower");
    ...
    public AeroPower(final AbstractCreature owner, final AbstractCreature source, final int amount) {
        name = NAME;
        ID = POWER_ID;
