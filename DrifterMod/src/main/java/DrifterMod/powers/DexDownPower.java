...
public class DexDownPower extends AbstractPower implements CloneablePowerInterface  {
    ...
    public DexDownPower(final AbstractCreature owner, final AbstractCreature source, final int amount) {
        name = NAME;
        ID = POWER_ID;
