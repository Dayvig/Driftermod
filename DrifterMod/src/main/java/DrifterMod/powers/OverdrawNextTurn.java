...
public class OverdrawNextTurn extends AbstractPower implements CloneablePowerInterface {
    ...
    public void atStartOfTurnPostDraw() {
        ...
        if (j > 0) {
            AbstractDungeon.actionManager.addToTop(new ApplyPowerAction(this.owner, this.owner, new TempMaxHandSizeInc(this.owner, this.owner, this.amount), this.amount));
